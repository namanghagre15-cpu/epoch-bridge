...
const client = new Client({
    ...
    puppeteer: {
        ...
        // ── 2-minute timeouts for slow Render cold-start ──────
        // timeout        → how long Puppeteer waits for the browser to launch
        // protocolTimeout → how long Puppeteer waits for ANY CDP command
        //                   (including Client.inject which times out on slow
        //                    Render free-tier containers with limited CPU)
        timeout: 120000,
