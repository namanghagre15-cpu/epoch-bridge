...
const client = new Client({
    ...
    puppeteer: {
        ...
        // ── 5-minute timeouts for slow Render free-tier ───────
        // Render free (512MB shared vCPU) needs 2.5+ min to
        // inject the WA Web JS bundle via CDP (Client.inject).
        // 120s was not enough — bumped to 300s (5 min).
        // timeout        → browser launch wait
        // protocolTimeout → ANY CDP command, incl. Client.inject ★
        timeout: 300000,
        ...
        args: [
            ...
            '--js-flags=--max-old-space-size=256',  // removed --lite-mode: throttles V8 JIT, slows inject
